...
| `pnpm discover:bundled`               | Discover authoritative upstreams for unstamped bundled skills via `npx skills find` + GitHub Trees probe. Writes a candidate JSON the maintainer reviews, then re-runs with `--apply <json>` to commit markers.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `pnpm vendor:skill <owner/repo>@<id>` | Forward-vendoring: pull a skill folder from an upstream GitHub repo into `skills/vendored/<id>/`. Supports `--path`, `--as`, `--force`, `--personal`. The canonical way to add a harvested skill to the bundled set.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `pnpm vendor:refresh`                 | Bulk refresh of vendored skills: probes each upstream's current folder hash, reports drift. `--apply` re-mirrors drifted skills; `--only foo,bar` scopes to a subset; `--json` machine-readable. Per-skill opt-out: add `"refresh": "manual"` to `.skills-bank.json`.                                                                                                                                                                                                                                                                                                                                                                                                    |
| `pnpm update:skill <name>`            | Pull a locally-edited skill from `~/.claude/skills/<name>/` back into this repo. Auto-detects bucket; `--bucket personal\|vendored` for new skills. Preserves provenance markers. `--dry` previews. Does NOT commit.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
