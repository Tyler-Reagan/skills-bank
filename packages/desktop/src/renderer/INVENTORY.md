...
| ModalHost.tsx                           | 994  | Modal router: `ActiveModal` discriminated union → one rendered modal, plus inline handlers for resolve-all, overwrite, and bulk-repair flows; internal `DrawerHost` wires SkillDetailDrawer (capability-gated callbacks)                                                                                                                                                                    | App                                                                              |
