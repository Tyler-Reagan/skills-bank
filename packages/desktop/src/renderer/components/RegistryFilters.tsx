 ...
 *
 * The pure filter/sort algebra (`RegistryFilterTag`, `RegistrySortState`,
 * `CHIP_DEFS`, `applyChipFilters`, `applySort`, `floatToTop`) lives in
 * `browseFilters.ts`; this file is only the presentation.
 *
